#' Adjacency matrix detailing the presence or absence of friendship
#' links between the `Lazega Lawyers'.
#'
#' Data on whether or not 71 lawyers in a northeastern American law
